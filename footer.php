    ...
    <div class="blog-and-newsletter-section">
        <div class="home3-blog-section mb-100">
            <div class="container">
                ...
                <div class="row g-4 mb-40">
                    <div class="col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms">
                        <div class="blog-card2 two">
                            <div class="blog-img-wrap">
                                <a href="travel-inspiration-details.php" class="blog-img">
                                    <img src="assets/images/jaipur-blog.jpg" alt="jaipur blog">
                                </a>
                                <a href="travel-inspiration-01.php" class="location">
                            ...
                            <div class="blog-content">
                                <a href="travel-inspiration-01.php" class="blog-date">24 February, 2025</a>
                                <h4><a href="travel-inspiration-details.php">Nature, Culture & Thrill: Travel Stories That Inspire.</a></h4>
                    ...
                    <div class="col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="400ms" data-wow-duration="1500ms">
                        <div class="blog-card2 two">
                            <div class="blog-img-wrap">
                                <a href="travel-inspiration-details.php" class="blog-img">
                                    <img src="assets/images/delhi-blog.jpg" alt="delhi blog">
                                </a>
                                <a href="travel-inspiration-01.php" class="location">
                                    <svg width="14" height="14" viewBox="0 0 14 14" xmlns="http://www.w3.org/2000/svg">
                                        <path
                            ...
                            <div class="blog-content">
                                <a href="travel-inspiration-01.php" class="blog-date">28 February, 2025</a>
                                <h4><a href="travel-inspiration-details.php">Dream. Explore. Discover. Where Will You Go Next?</a></h4>
                    ...
                    <div class="col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="600ms" data-wow-duration="1500ms">
                        <div class="blog-card2 two">
                            <div class="blog-img-wrap">
                                <a href="travel-inspiration-details.php" class="blog-img">
                                    <img src="assets/images/agra-blog.jpg" alt="agra blog">
                                </a>
                                <a href="travel-inspiration-01.php" class="location">
                                    <svg width="14" height="14" viewBox="0 0 14 14" xmlns="http://www.w3.org/2000/svg">
                                        <path
                            ...
                            <div class="blog-content">
                                <a href="travel-inspiration-01.php" class="blog-date">05 March, 2025</a>
                                <h4><a href="travel-inspiration-details.php">Top 10 Historical to Visit This Summer Season.</a></h4>
                ...
                <div class="row wow animate fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                    <div class="col-lg-12 d-flex justify-content-center">
                        <a href="travel-inspiration-01.php" class="primary-btn1 two black-bg">
                            <span>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6">
                        <div class="footer-logo-and-addition-info">
                            <a href="index.html" class="footer-logo">
                                <img src="assets/img/taj-legacy.svg" alt="">
                            </a>
                            <div class="address-area">
                                <p>Taj Legecy is a trusted name in the travel industry, offering seamless travel planning, personalized itineraries, and unforgettable adventures. With years of experience and a network of global partners, we ensure a hassle-free and memorable journey for every traveler.</p> 
                            </div>
                            <ul class="social-list">
                                <li><a href="https://www.facebook.com/profile.php?id=61586208489621"><i class="bx bxl-facebook"></i></a></li>  
                                <li><a href="https://www.instagram.com/taj_legacy_official/"><i class="bx bxl-instagram-alt"></i></a></li>
                            </ul>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 d-flex justify-content-md-end">
                        <div class="footer-widget">
                            ...
                            <ul class="widget-list">
                                ...
                                <li><a href="golden-triangle-tour-packages.php">Golden Triangle Tours</a></li>
                                <li><a href="same-day-tour-packages.php">Same Day Tours</a></li>
								<li><a href="plan-my-trip.php">Plan My Trip</a></li>
   ...
   <div class="col-lg-3 col-md-4 col-sm-6 d-flex justify-content-md-end">
        <div class="footer-widget">
         <div class="widget-title">
          ...
          <li><a href="golden-triangle-tour-4-days.php">Golden Triangle Tour 4 days</a></li>
          <li><a href="golden-triangle-tour-5-days.php">Golden Triangle Tour 5 days</a></li>
          ...
          <li><a href="same-day-agra-tour-by-train.php">Same Day Agra Tour By Train</a></li>
          </ul>
       </div>
    </div>
                    <div class="col-lg-3 col-sm-6 d-flex justify-content-lg-end">
                        <div class="footer-widget">
                            ...
                            <ul class="contact-list">
                                <li class="single-contact">
                                    ...
                                    <div class="content">
                                        <span>WhatsApp</span>
                                        <a href="https://wa.me/+91 89587 38321">+91 89587 38321</a>
                                    </div>
                                </li>
                                <li class="single-contact">
                                    <div class="icon">
                                    ...
                                    <div class="content">
                                        <span>Mail Us</span>
                                      <a href="mailto:info@tajlegacy.com">info@tajlegacy.com</a>
                                    </div>
                                </li>
                                <li class="single-contact">
                                    <div class="icon">
                                    ...
                                    <div class="content">
                                        ...
                                        <a href="tel:+91 89587 38321">+91 89587 38321</a>
                                    </div>
                                </li>
                            </ul>
                        </div>
        ...
        <div class="footer-bottom">
            <div class="container">
                <div class="copyright-and-payment-method-area">
                    <p>Copyright 2026 <a href="https://www.mldigital.in/">Taj Legacy</a> | All Right Reserved. - Design By <a href="https://www.mldigital.in/">ML Digital</a></p>
