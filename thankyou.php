...
<head>
	...
	<!-- Canonical -->
    <link rel="canonical" href="https://tajlegacy.com/thankyou.php">
            ...
            <div class="row g-xl-4 g-lg-3 g-4 mb-100">
                <div class="col-lg-12 col-md-12">
                    <div class="single-contact">
                        ...
                        <h4>Thank You <?php echo $_GET['name']; ?></h4>
                        <h6>Your Query Has been Submitted Successfully</h6>
                        <p>An Expert From Taj Legacy Team Will Contact you Soon.</p>
                    </div>
                </div>
