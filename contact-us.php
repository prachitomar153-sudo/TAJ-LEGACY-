...
<head>
	...
	<title> Conatct Us Taj Legacy – Experience Agra’s Royal Past in One Day</title>
	
	<meta name="description" content="Contact Taj Legacy Tour to book Taj Mahal tours, Agra sightseeing, Golden Triangle tours, and tailor-made travel experiences across India.">
	
    <meta name="keywords" content="Taj Legacy Tour, Taj Mahal heritage tour, same day Taj Mahal tour from Delhi, Taj Mahal day trip, Agra tour by car,Taj Legacy Tour">
	
	<!-- Canonical -->
    <link rel="canonical" href="https://tajlegacy.com/contact-us.php">
...
<body class="tt-magic-cursor">
    ...
    <div class="breadcrumb-section" style="background-image:linear-gradient(rgba(0, 0, 0, 0.3), rgba(0, 0, 0, 0.3)), url(assets/images/content-taj.jpg);">  
        <div class="container">
            ...
            <div class="row g-xl-4 g-lg-3 g-4 mb-100">
                <div class="col-lg-4 col-md-6">
                    <div class="single-contact">
                        ...
                        <h4>Delhi</h4>
                        <h6><span>Contact :</span> <a href="#">+91 89587 38321</a></h6>
                        <p>Taj Legacy, 106 HIG, Nehru Enclave, Samshabad Road, Agra,  UP - 282001</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    ...
                    <div class="col-xl-8 col-lg-10">
                        <div class="contact-form-wrap">
                            <div class="section-title text-center mb-60">
                                <h2>Get in Touch!</h2>
                                <p>We’re happy to hear from you! Whether you need information about our tours, wish to plan a custom journey.</p>
                            </div>
							
                 <form action="contact-us-submit.php" method="POST"  class="enquiry-form-wrapper" >
                                <div class="row g-4 mb-60">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-inner">
                                           ...
                                           <input type="text" name="email" placeholder="info@example.com">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-inner">
									...
									<div class="col-md-12">
                                        <div class="form-inner">
                                            ...
                                            <textarea  name="requirements" placeholder="Write somethings about inquiry"></textarea>
                                        </div>
                                    </div>
	...
	<!-- Nice Select JS - needed to keep this script here bcoz. it breaks code in other pages -->
